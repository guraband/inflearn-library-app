...
- 2023.06.15
    ...
    - 섹션4 > 28강. SQL join에 대해 알아보자 학습 완료
    - 섹션4 > 29강. N+1 문제를 해결하는 방법! fetch join 학습 완료
    - 섹션4 > 30강. 조금 더 깔끔한 코드로 변경하기 학습 완료
        - UserService.getUserLoanHistories 메소드 리팩토링
    - 섹션4 > 31강. 두 번째 요구사항 클리어! 학습 완료
- 2023.06.16
    - 섹션5 > 32강. 책 통계 보여주기 - 프로덕션 코드 개발 학습 완료
- 2023.06.17
    - 섹션5 > 33강. 책 통계 보여주기 - 테스트 코드 개발과 리팩토링 학습 완료
- 2023.06.18
    - 섹션5 > 34강. 다양한 SQL을 알아보자! 학습 완료
    - 섹션5 > 35강. 애플리케이션 대신 DB로 기능 구현하기 학습 완료
        - 집계를 쿼리에서 처리
    - 섹션5 > 36강. 세번째 요구사항 클리어 학습 완료
